...
public class SecureSessionTest extends DevApiBaseTestCase {
    ...
    final String trustStorePath = "libraries/mysql-connector-java-8.0.18/src/test/config/ssl-test-certs/ca-truststore";
    ...
    final String clientKeyStorePath = "libraries/mysql-connector-java-8.0.18/src/test/config/ssl-test-certs/client-keystore";
